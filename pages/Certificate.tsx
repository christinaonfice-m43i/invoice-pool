...
const Certificate: React.FC = () => {
    ...
    const isTransferDisabled = !nft.transferable || transferredIds.has(nft.id);
    const transferButtonTitle = !nft.transferable 
        ? "中獎捐贈後無法轉移" 
        : transferredIds.has(nft.id)
            ? "此憑證已轉移" 
            : "轉移此 NFT";
